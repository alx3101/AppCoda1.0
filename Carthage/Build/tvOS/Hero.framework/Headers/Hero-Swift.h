...
SWIFT_CLASS("_TtC4Hero24HeroViewControllerConfig")
...
SWIFT_CLASS("_TtC4Hero19SnapshotWrapperView")
...
@property (nonatomic, copy) IBInspectable NSString * _Nullable heroNavigationAnimationTypeString;
@end


@interface UITabBarController (SWIFT_EXTENSION(Hero))
@property (nonatomic, copy) IBInspectable NSString * _Nullable heroTabBarAnimationTypeString;
@end
...
@property (nonatomic, copy) IBInspectable NSString * _Nullable heroID;
@property (nonatomic) IBInspectable BOOL isHeroEnabled;
@property (nonatomic) IBInspectable BOOL isHeroEnabledForSubviews;
@property (nonatomic, copy) IBInspectable NSString * _Nullable heroModifierString;
@end



@interface UIViewController (SWIFT_EXTENSION(Hero))
- (IBAction)ht_dismiss:(UIView * _Nonnull)sender SWIFT_DEPRECATED_MSG("", "hero.dismissViewController()");
- (IBAction)hero_dismissViewController SWIFT_DEPRECATED_MSG("", "hero.dismissViewController()");
- (IBAction)hero_unwindToRootViewController SWIFT_DEPRECATED_MSG("", "hero.unwindToRootViewController()");
@end


@interface UIViewController (SWIFT_EXTENSION(Hero))
@property (nonatomic, copy) IBInspectable NSString * _Nullable heroModalAnimationTypeString;
@property (nonatomic) IBInspectable BOOL isHeroEnabled;
@end
